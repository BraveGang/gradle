    ...
    private static enum DetailLevel {
        ...
        SIMPLIFIED(
            ...
            new FlameGraphSanitizer(
                new FlameGraphSanitizer.CompositeSanitizeFunction(
                    [
                        new FlameGraphSanitizer.ChainCollapsingFunction("GradleMain.main(...)", "DefaultGradleLauncher.executeTasks(...)"),
                        new FlameGraphSanitizer.ChainCollapsingFunction("TaskExecutorWorker.run(...)", "TaskActionWrapper.execute(...)"),
                        new FlameGraphSanitizer.RegexBasedSanitizerFunction(
